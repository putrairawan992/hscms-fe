      ...
      <div class="menu-button-t-dashboard-drawer">
        <div class="menu-button-remunerasi-drawer">
          ...
          <div class="menu-drawer">
            <div
              :class="
                pageActive == 'index' ? 'dashboard1-drawer' : 'lp-center-drawer'
              "
              @click="$router.push('/dashboard-mitra')"
            >
              Dashboard
            </div>
            <div class="help-center-drawer" style="color: #a3a3a3" @click="">
              Help Center
            </div>
            ...
            <div
              :class="
                pageActive == 'job' ? 'dashboard1-drawer' : 'lp-center-drawer'
              "
              @click="$router.push('/job-vacancy')"
            >
              Job Vacancy
            </div>
            <div
