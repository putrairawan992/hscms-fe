...
export default {
    ...
    setup() {
        const { getJob, putJob } = API()
        return { getJob, putJob };
    },
    props: {
        id_job_post: { type: String, default() { return null } },
        successEditJob: { type: Function, default() { return {} } },
    },
    async mounted() {
        this.getData();
    },
