                ...
                <div style="height: 676px; overflow: auto;  overflow-x: hidden">
                    <v-row class="mt-0">
                        <v-col cols="6" class="pt-0">
                            ...
                            <v-checkbox class="input-checkbox mt-2" color="#ae445a" v-for="n in 25" hide-details>
                                <template v-slot:label>
                                    <div class="checkbox-remunerasi-label">Kontrak</div>
                                </template>
                            </v-checkbox>
                        </v-col>
                        ...
                        <v-col cols="6" class="pt-0">
                            ...
                            <v-checkbox class="input-checkbox mt-2" color="#ae445a" v-for="n in 15" hide-details>
                                <template v-slot:label>
                                    <div class="checkbox-remunerasi-label">Kontrak</div>
                                </template>
                            </v-checkbox>
