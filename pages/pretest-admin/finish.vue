                ...
                <v-row align="center" class="mt-6">
                  ...
                  <v-col cols="12">
                    <img
                      class="ma-auto"
                      alt=""
                      src="@/assets/svg/finish-pretest-1.svg"
                    />
                  </v-col>
                  <v-col cols="12">
                    <p class="desc-1">
                    ...
                    <p class="desc-2">
                      Pengumuman Resmi Seleksi Administrasi akan
                      diinformasikan<br />
                      lebih lanjut melalui
                      <span style="color: #ae445a">situs</span> ini
                    </p>
                  </v-col>
                </v-row>
              </div>
            ...
            <div v-else class="" style="position: relative">
              <div class="blokade-parent pt-1">
                <v-row align="center" class="mt-6">
                  <v-col cols="12">
                    <p class="desc-1">
                      Jawaban anda sudah terkirim. Terima kasih sudah mengikuti
                      pre-test. Semoga berhasil!
                    </p>
                    <p class="desc-2">
                      Pengumuman Resmi Seleksi Administrasi akan
                      diinformasikan<br />
                  ...
                  <v-col cols="12">
                    <img
                      class="ma-auto"
                      alt=""
                      src="@/assets/svg/finish-pretest-2.svg"
                    />
                  </v-col>
                </v-row>
              </div>
