            ...
            <v-row align="stretch" class="mb-4">
              <v-col cols="12" class="">
                <div class="">
                  ...
                  <div
                    class="mt-6"
                    v-if="question?.type_test == 'Modul Pilihan Ganda'"
                  >
                    ...
                    <div v-for="(value, key) in question?.question">
                      <ol class="pl-4">
                        <li
                          class="preview-question-text text-left mt-4"
                          :value="
                      ...
                      <v-radio-group
                        :value="value.answer"
                        @change="submitAnswer(value, $event)"
                        row
                        class="radio-group-questions mt-0"
                      >
                        <v-radio
                          :label="
                            value?.multiple_choise_question
                              ? value?.multiple_choise_question[0]?.text
                              : ''
                          "
                          class="pa-2 pt-1"
                          value="a"
                        ...
                        <v-radio
                          :label="
                            value?.multiple_choise_question
                              ? value?.multiple_choise_question[1].text
                              : ''
                          "
                          class="pa-2 pt-1"
                          value="b"
                        ...
                        <v-radio
                          :label="
                            value?.multiple_choise_question
                              ? value?.multiple_choise_question[2].text
                              : ''
                          "
                          class="pa-2 pt-1"
                          value="c"
                        ...
                        <v-radio
                          :label="
                            value?.multiple_choise_question
                              ? value?.multiple_choise_question[3].text
                              : ''
                          "
                          class="pa-2 pt-1"
                          value="d"
                  ...
                  <div
                    class="mt-6"
                    v-else-if="question?.type_test == 'Modul Essay'"
                  >
                    <div class="pretest-preview-title text-left">
                      Instruksi soal
                    </div>
                    ...
                    <div
                      v-if="question?.question.length > 0"
                  ...
                  <div class="mt-6" v-else>
                    <div
                      class="pretest-preview-title text-left"
...
export default {
  ...
  methods: {
    ...
    async getQuestions() {
      ...
      await this.getQuestionAPI(this.job_id, this.module_id, this.page).then(
        (result) => {
