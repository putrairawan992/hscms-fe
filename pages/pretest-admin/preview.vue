          ...
          <div class="my-8 pt-1">
            <v-row align="center">
              <v-col cols="12" class="text-left">
                ...
                <i class="mt-0"> Ikuti sesuai arahan deskripsi </i>
              </v-col>
            </v-row>
            ...
            <v-row align="stretch" class="mb-4">
              <v-col cols="12" class="">
                ...
                <div class="pretest-preview-text text-left">
                  Bacalah deskripsi soal secara seksama dan jawablah
                  pertanyaan-pertanyaan yang diajukan sebaik mungkin. Perhatikan
                  durasi waktu yang berada di sisi atas setiap soal. Semoga
                  berhasil!
                </div>
              </v-col>
              <v-col cols="12" xs="6" md="6" lg="6" xl="6" xxl="6" class="">
                ...
                <table>
                  <tr>
                    ...
                    <td class="pretest-preview-text text-left pl-4">
                      {{ preview.type }}
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="pretest-preview-text text-left pl-1">:</td>
                    <td class="pretest-preview-text text-left pl-4">
                      {{ preview.duration }} Menit
                    </td>
                  </tr>
                  <tr>
                    <td class="pretest-preview-text text-left">
                      Jumlah Pertanyaan
                    </td>
                    <td class="pretest-preview-text text-left pl-1">:</td>
                    <td class="pretest-preview-text text-left pl-4">
                      {{ preview.count_question }} Pertanyaan
                    </td>
                  </tr>
                </table>
              </v-col>
                ...
                <div class="">
                  ...
                  <div class="mt-6">
                    ...
                    <div
                      ...
                      v-html="preview.instructions"
                    />
                    <div v-if="preview.type == 'Modul Pilihan Ganda'">
                      <ol class="preview-question-text text-left mt-4">
                        <li>
                          Soal nomor satu, ada empat pilihan ganda bisa langsung
                          dijawab di sini
                        </li>
                      </ol>
                      <v-radio-group
                        v-model="inline"
                        row
                        class="radio-group-questions mt-0"
                      >
                        <v-radio label="Pilihan A" value="radio-1"></v-radio>
                        <v-radio label="Pilihan B" value="radio-2"></v-radio>
                        <v-radio label="Pilihan C" value="radio-3"></v-radio>
                        <v-radio label="Pilihan D" value="radio-4"></v-radio>
                      </v-radio-group>
                    </div>
                    <div v-else-if="preview.type == 'Modul Essay'">
                      <ol class="preview-question-text text-left mt-4">
                        <li>
                          Soal nomor satu, jabarkan/tulis essai mengenai apa
                          gitu
                        </li>
                      </ol>
                      <TextEditor
                    ...
                    <div v-else>
                      <ol class="preview-question-text text-left mt-4">
                        <li>
                          Soal nomor satu, bisa akses soal disini, upload
                          jawaban disini
                        </li>
                      </ol>
                      <button class="drop-file-parent mt-4 mb-6">
                        ...
                        <div class="drop-file-here-or-click-to-upl-parent">
                          <b class="drop-file-here"
                            >Drop file here or click to upload</b
                          >
              ...
              <v-col
                ...
                xl="6"
                xxl="6"
                class="container-preview-right d-flex flex-column"
              >
                <v-row align="center">
                  <v-col>
                    <v-row>
                      <v-col
                        cols="12"
                        class="pretest-preview-text text-center pb-0"
                      >
                        <div style="width: 283px; margin: auto">
                          Apabila sudah siap mengerjakan soal, silahkan klik
                          tombol “Start Test” untuk memulai.
                        </div>
                      </v-col>
                      <v-col
                        cols="12"
                        class="pretest-preview-title text-center"
                      >
                        Semoga Berhasil!
                      </v-col>
                      <v-col cols="12">
...
export default {
  ...
  methods: {
    ...
    startTest() {
      return this.$router.push("/pretest-admin/question");
    },
  },
};
</script>
