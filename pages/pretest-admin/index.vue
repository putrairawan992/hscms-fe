<template>
  <div>
    <v-card
      class="card-register"
      style="min-height: 785px"
      :style="pretests.length > 1 ? 'min-height: 925px;' : 'min-height: 785px;'"
    >
            ...
            <div class="blokade-parent my-8 pt-1">
              <v-row align="center" class="mb-3">
                <v-col cols="12" class="text-left">
                  <div class="open-job-dan-draft">Pre-Test Admin</div>
                  <i class="mt-0"
                    >Mohon baca petunjuk sesuai deskripsi secara teliti.
                    Pastikan anda terhubung dengan koneksi internet yang stabil
                    sebelum mengerjakan tes.</i
                  >
                </v-col>
              </v-row>
              ...
              <div
                ...
                :style="
                  pretests.length > 1 ? 'height: 925px;' : 'height: 745px;'
                "
              ...
              >
                ...
                >
                  ...
                  <v-row align="center" class="ma-0 mb-4 pa-2 list-pretest">
                    ...
                    >
                      <div class="pretest-todo-title text-left mb-1">
                        {{ key + 1 }}. {{ value.category_name }}
                      </div>
                      <div class="frame-pretest-todo pt-2 px-2">
                        ...
                        <div class="frame-div">
                          ...
                          <div
                            v-else
                            class="jun-2023-wrapper text-right"
                            style="width: 98px"
                          >
                            <div
                              v-if="value.in_review == true"
                              class="text-list-todo"
                            >
                              <i>In Review</i>
                            </div>
                            <div v-else class="text-list-todo">
                              Skor: {{ Math.round(value.score) }}
                            </div>
                          </div>
...
const pretests = [
  {
    job_post_id: "aKNhyKb0Xb8vNFHBy0IFq",
    job_provider_name: "DBT\tTribe ENT OCA",
    job_title: "Programmer C++",
    status_active: "Unactive",
    detail: [
      {
        id: "2M-8Jkm7NtAQ7uxombCp3",
        category_name: "Wawancara Mandiri",
        deadline: "2024-12-31T12:00:00.000Z",
        modul: {
          id: "pSK8Ug_aABwWynGqbdvKZ",
          pretest_modul_id: "8bHKodkPqAUEHHpa16r7O",
          type: "Modul Live Recording",
          title_test: "tes",
        },
        in_review: true,
        score: null,
      ...
      {
        id: "8zKiH1-8yLzo2CxKkZORV",
        category_name: "Tes Kepribadian",
        deadline: "2024-12-31T12:00:00.000Z",
        modul: null,
      },
      {
        id: "d4kdUL9zxzu78tXZ6KMQG",
        category_name: "Tes Kompetensi",
        deadline: "2024-12-31T12:00:00.000Z",
        modul: null,
      },
    ],
  ...
  {
    job_post_id: "bqgMKMemVWq4Q7ATcxBlX",
    job_provider_name: "SINAR JAYA SUKSES",
    job_title: "Teknik Mesin",
    status_active: "Unactive",
    detail: [
      {
        id: "2M-8Jkm7NtAQ7uxombCp3",
        category_name: "Wawancara Mandiri",
        deadline: "2025-02-11T12:00:00.000Z",
        modul: {
          id: "AU6eAzwoTroCkx7_riqFk",
          pretest_modul_id: "cFMuFXv-WKGHKGx2CZkfw",
          type: "Modul Essay",
          title_test: "test essay",
        },
        in_review: true,
        score: null,
      },
      {
        ...
        deadline: "2025-02-11T12:00:00.000Z",
        modul: {
          id: "dxo4m_uyhibnUl6EBR7_D",
          pretest_modul_id: "cFMuFXv-WKGHKGx2CZkfw",
          type: "Modul Pilihan Ganda",
          title_test: "Test",
        },
        in_review: false,
        score: "0",
      },
      {
        ...
        deadline: "2025-02-11T12:00:00.000Z",
        modul: {
          id: "-700yPSRarExG_X0HvMC9",
          pretest_modul_id: "cFMuFXv-WKGHKGx2CZkfw",
          type: "Modul Essay",
          title_test: "Kompetensi",
        },
      },
    ],
  },
...
const haveDoneTest = isClient
  ? localStorage.getItem("haveDoneTest") === "true"
  : false;
