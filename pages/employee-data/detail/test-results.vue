<template>
    <div>
        <HasilTes-PilihanGanda v-if="detail?.module?.modul_type == 'Modul Pilihan Ganda'"/>
        <HasilTes-Essay v-if="detail?.module?.modul_type == 'Modul Essay'"/>
        <HasilTes-UploadDokumen 
            v-if="
...
export default {
    ...
    async mounted(){
        ...
        if(this.detail == null){
            return this.$router.push("/employee-data/detail")
        }
