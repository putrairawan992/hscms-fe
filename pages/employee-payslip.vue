                            ...
                            <div class="history-1">
                                <div class="frame-parent-draft">
                                    <div class="foto-perusaahaan-parent">
                                        ...
                                        />
                                        <b class="">{{ value.provider_name }}</b>
                                    </div>
                                    <div class="">{{ value.create_at }} WIB</div>
...
export default {
    ...
    methods: {
        async getData(){
            await this.getPayslip(this.year, this.month, this.limit, this.paginate).then((result)=>{
