<template>
  <div>
        ...
        <div class="blokade-parent ma-8 pt-1" style="height: 850px">
          <v-row align="center" class="my-4">
            <v-col cols="12" class="text-left">
              <div class="open-job-dan-draft">Lowongan Pekerjaan</div>
            </v-col>
                ...
                <v-row class="card-vacancy">
                  ...
                  >
                    <v-row>
                      <v-col cols="4">
                        <img
                          class="job-vacancy-icon mt-3 mb-1"
                          alt=""
                      ...
                      <v-col cols="8">
                        ...
                        >
                          <div class="mei-2023 py-2">
                            2 Mei 2023 | 09:00 WIB
                          </div>
                          <div
                            class="vacancy-status-container mt-1"
                        ...
                        <div class="card-vacancy-edit-parent">
                          <img
                            class="bishare-fill-icon ml-2"
                            alt=""
                            src="@/assets/svg/bisharefillred.svg"
                            @click="copyLink(job.id)"
                          />
                        </div>
                      </v-col>
                    </v-row>
    ...
    <AlertApproval
      content="Lowongan akan dihentikan. Anda yakin ingin menghentikan?"
      :onApprove="closeAlertApproval"
      :closeDialog="closeAlertApproval"
...
export default {
  ...
  setup() {
    ...
    return { getJobs, postApplyJob, copyTextToClipboard };
  },
  async mounted() {
  ...
  methods: {
    ...
    copyLink(id) {
      const text = `${window.location.origin}/job/share/${id}`;
      const { copyTextToClipboard } = useClipboard();
